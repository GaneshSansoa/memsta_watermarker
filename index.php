...
<nav class="navbar navbar-expand-sm navbar-dark bg-primary mb-3">
        <div class="container">
            <a class="navbar-brand" href="/">Memsta Watermark Dashboard</a>
	...
	<footer class="bg-primary py-3 mt-3">
		<div class="container">
			...
			<div class="col-sm-6 "> <p class="text-md-right text-center text-white font-weight-bold">Creativity by Hex Enciphers</p></div>
			</div>
		</div>
	</footer>
